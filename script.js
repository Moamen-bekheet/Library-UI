...
function Book(title, author, num_pages, read){
    ...
    this.read = (read==='on')? 'Already read':'Not yet read';
}
...
form.addEventListener('submit', (e)=>{
    ...
    let book = new Book(getFormData.get('title'), getFormData.get('author'), getFormData.get('num_pages'), readAlready.value);
    myLibrary.push(book);
    const bookCard = document.createElement('div');
    ...
    markAsReadLabel.for = 'read-button'
    ...
    markAsReadButton.id = 'read-button';
